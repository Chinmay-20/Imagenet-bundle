...
#python fine_tune_cars.py --vgg vgg16/vgg16 --checkpoints checkpoints --prefix vggnet --start-epoch 30

#exp 2
#python fine_tune_cars.py --vgg vgg16/vgg16 --checkpoints checkpoints --prefix vggnet
#python fine_tune_cars.py --vgg vgg16/vgg16 --checkpoints checkpoints --prefix vggnet --start-epoch 100

#exp 3
#python fine_tune_cars.py --vgg vgg16/vgg16 --checkpoints checkpoints --prefix vggnet
#python fine_tune_cars.py --vgg vgg16/vgg16 --checkpoints checkpoints --prefix vggnet --start-epoch 50
...
opt=mx.optimizer.SGD(learning_rate=1e-4,momentum=0.9,wwdd=0.0005,rescale_grad=1.0/batchSize)
ctx=[mx.gpu(3)]
